 ...
 */
final class Version20241206092155 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX fk_bid_auction ON bids');
        $this->addSql('DROP INDEX fk_bid_user ON bids');
        $this->addSql('ALTER TABLE bids DROP auction_id, DROP user_id, DROP bid_amount, DROP bid_time');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE bids ADD auction_id INT NOT NULL, ADD user_id INT NOT NULL, ADD bid_amount NUMERIC(10, 2) NOT NULL, ADD bid_time DATETIME DEFAULT NULL');
        ...
        $this->addSql('CREATE INDEX fk_bid_auction ON bids (auction_id)');
        $this->addSql('CREATE INDEX fk_bid_user ON bids (user_id)');
    }
}
